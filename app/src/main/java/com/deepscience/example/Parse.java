...
public class Parse {
    public static void parse(String pcapFilePath) {
//        String pcapFilePath = "F:\\Log\\capture.pcap";
        try {
...
//                System.out.println("capturedLength  " + capturedLength);
                // 读取数据包内容
...
//                System.out.println("ipHeaderLength  " + ipHeaderLength);
                ...
                if (ipHeader.getProtocol() != IPHeader.PROTOCOL_UDP) {
                    System.out.println("This packet is not UDP segment");
                    continue;
                }
                ...
                System.out.println(RTCPParse.parseTaoBaoLiveUrl(payload));
//                parseRTCPAppPacket(payload);
            }
